		...
		return (
			<div className="page-container">
				...
				<div className="page-body" ref={this.pageBody}>
					...
					<p>
						Lambda School helped me to adapt my previous skills to the world of software development. During
						my six months there, I was taught the fundamentals of computer science and built
						applications using countless technologies. The priority was being able to learn quickly while
						tackling problems that you have never faced before. I came into this program with a strong
						foundation in Javascript and left knowing that I could pick up any other technology with ease.
					</p>
				</div>
